...
class CustomBottomBarWithSheet extends StatefulWidget {
  CustomBottomBarWithSheet({
    Key? key,
    required this.items,
    // this.sheetChild,
  ...
  @override
  _CustomBottomBarWithSheetState createState() =>
      _CustomBottomBarWithSheetState();
}

class _CustomBottomBarWithSheetState extends State<CustomBottomBarWithSheet>
    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: <Widget>[
          ...
          _isOpened ? Expanded(child: SizedBox()) : SizedBox()
        ],
      ),
    );
  }
